...
É possível usar o Exercício \ref{prop:basis_of_r} para criar outros métodos de verificar a mensurabilidade de uma função real (ou em $\Rextend$). Veja o corolário abaixo.
...
\integralOfNonNegativeFunctionIsLinear
